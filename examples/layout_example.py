...
from cute_viz import render_layout, display_layout
...
def main():
    ...
    print(f"Hierarchical layout {layout_hierarchical} visualized in hierarchical coordinate space: {layout_hierarchical.shape}")
    render_layout(layout_hierarchical, "assets/layout_hierarchical_2.svg", coord_space=layout_hierarchical.shape)
    print("Hierarchical layout saved to assets/layout_hierarchical_2.svg")
