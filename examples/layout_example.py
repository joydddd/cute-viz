...
def main():
    ...
    layout = cute.make_layout((8, 7), stride=(7, 1))

    # Render to SVG file
    render_coord_space_svg(layout, "assets/layout.svg")
    ...
    render_coord_space_svg(layout_vector, "assets/layout_vector.svg")
    ...
    render_coord_space_svg(layout_custom, "assets/layout_custom_stride.svg")
    ...
    render_coord_space_svg(layout_hierarchical, "assets/layout_hierarchical.svg")
    print("Hierarchical layout saved to assets/layout_hierarchical.svg")


    render_coord_space_svg(layout_hierarchical, "assets/layout_hierarchical_2.svg", layout_hierarchical.shape)
